...
<title>VetCareQR — Municipal Pet Healthcare System with QR Integration</title>
<meta name="description" content="VetCareQR is a web-based medical record system with QR code integration and predictive analytics for municipal pet healthcare in Santa Rosa, Laguna.">
    ...
    <div class="row g-4">
      ...
      <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
        <div class="feature-card">
          ...
          <p>Track disease outbreaks and risk levels across different barangays with our interactive map to protect the entire community.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6" data-aos="fade-up" data-aos-delay="300">
        <div class="research-card">
          ...
          <p>Our system adheres to the Data Privacy Act of 2012 (RA 10173), ensuring all pet and owner information is securely handled with end-to-end encryption.</p>
        </div>
      </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-4 mb-4 mb-lg-0">
        ...
        <p>Santa Rosa Municipal Veterinary Services</p>
        <p>Asia Technological School of Science and Arts</p>
      </div>
      <div class="col-lg-4 mb-4 mb-lg-0">
