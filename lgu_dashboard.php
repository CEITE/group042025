...
// Calculate medical record statistics for the summary view
$total_records = 0;
$completed_records = 0;
$pending_records = 0;
$recent_records = [];
...
foreach ($pets_with_records as $pet) {
    ...
    foreach ($pet['medical_records'] as $record) {
        ...
        // Collect all records for recent display
...
// Show only the 5 most recent records for summary view
$recent_records_display = array_slice($recent_records, 0, 5);
?>
                                ...
                                <div id="summaryView">
                                    <div class="row mb-4">
                                        <div class="col-md-3">
                                            <div class="summary-stat-card">
                                                ...
                                                <p class="mb-0 text-muted">Total Pets</p>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="summary-stat-card">
                                                <h3 class="text-success"><?php echo $total_records; ?></h3>
                                                <p class="mb-0 text-muted">Medical Records</p>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="summary-stat-card">
                                                <h3 class="text-warning"><?php echo $completed_records; ?></h3>
                                                <p class="mb-0 text-muted">Completed</p>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="summary-stat-card">
                                                <h3 class="text-info"><?php echo $pending_records; ?></h3>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php foreach ($recent_records_display as $record): ?>
                                                <tr>
